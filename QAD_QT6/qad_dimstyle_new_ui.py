...
class Ui_DimStyle_New_Dialog(object):
    def setupUi(self, DimStyle_New_Dialog):
        ...
        self.DimStyleNameFrom.currentIndexChanged.connect(DimStyle_New_Dialog.DimStyleNameFromChanged)
        self.newDimStyleName.textEdited.connect(DimStyle_New_Dialog.newStyleNameChanged)
