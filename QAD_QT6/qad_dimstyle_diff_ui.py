...
class Ui_DimStyle_Diff_Dialog(object):
    def setupUi(self, DimStyle_Diff_Dialog):
        ...
        self.dimStyle1.currentIndexChanged.connect(DimStyle_Diff_Dialog.DimStyleName1Changed)
        self.dimStyle2.currentIndexChanged.connect(DimStyle_Diff_Dialog.DimStyleName2Changed)
