...
class Ui_Options_Dialog(object):
    def setupUi(self, Options_Dialog):
        ...
        self.buttonBox.clicked.connect(Options_Dialog.ButtonBOX_Apply)
        ...
        self.horizontalSlider_CURSORSIZE.sliderMoved.connect(Options_Dialog.horizontalSlider_CURSORSIZE_moved)
        self.lineEdit_CURSORSIZE.textEdited.connect(Options_Dialog.lineEdit_CURSORSIZE_textChanged)
        self.horizontalSlider_CURSORSIZE.valueChanged.connect(Options_Dialog.horizontalSlider_CURSORSIZE_moved)
        self.horizontalSlider_AUTOSNAPSIZE.valueChanged.connect(Options_Dialog.horizontalSlider_AUTOSNAPSIZE_changed)
        self.horizontalSlider_APERTURE.valueChanged.connect(Options_Dialog.horizontalSlider_APERTURE_changed)
        self.horizontalSlider_PICKBOX.valueChanged.connect(Options_Dialog.horizontalSlider_PICKBOX_changed)
        self.horizontalSlider_GRIPSIZE.valueChanged.connect(Options_Dialog.horizontalSlider_GRIPSIZE_changed)
